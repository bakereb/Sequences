...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [55, 45, 20, 55.4, 999999, 2333]
    threshold = 38
    expected = 5
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 1
    actual = count_positive_sines([5, 44, 23, 12])
    print()
    ...
    # Test 12:
    expected = 3
    actual = count_positive_sines([66, 34, 1, 33, 55, 66])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 9:
    expected = -42
    actual = sum_first_n([55, 3, -100, 44], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 10:
    expected = 0
    actual = sum_first_n([-223, -177, -100, 500], 4)
    print()
    print('Test 10 expected:', expected)
    print('       actual:  ', actual)
